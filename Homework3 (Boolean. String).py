...
print('Your name is {Username} and you\'re {Userage} years old'.format(Username = Username,Userage = Userage))
...
print(string_1.lstrip(), string_2.lstrip(), string_3.lstrip(), string_4.lstrip(),sep='\n')
#   b) from the end of the line
print(string_1.rstrip(), string_2.rstrip(), string_3.rstrip(), string_4.rstrip(),sep='\n')
...
print(string_1.lower().startswith('be'),string_2.lower().startswith('be'),\
        string_3.lower().startswith('be'),string_4.lower().startswith('be'))
