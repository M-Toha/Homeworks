...
if year == 0:
    ...
    if month > 12 or month < 1:
        ...
        if (
            day < 1
            or day > 31
            or (day > 30 and month in (2, 4, 6, 9, 11))
            ...
            if day == 31 and month == 12:
                ...
                if year < 0:
                    print(f"{-year}-{month+1}-1 BC")
                else:
                    print(f"{year}-{month+1}-1")
            else:
                if year < 0:
                    print(f"{-year}-{month}-{day+1} BC")
                else:
...
if len(string) > 5:
    print("longer then five characters")
elif len(string) == 5:
    print("five characters long")
else:
    print("shorter then five characters")
